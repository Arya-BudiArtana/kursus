...
@enderror"
                            id="tahun_pengadaan" name="tahun_pengadaan" value=
"{{ old('tahun_pengadaan') }}" required>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href=
"{{ route('admin.laptop.index') }}" class="btn btn-secondary me2">
                            Batal</a>
